...
import {IBalancerVault} from "./IBalancerWeightedPool.sol";

/**
 *  @title ICygnusNebulaOracle Interface to interact with Cygnus' Chainlink oracle
 */
interface IBalancerNebula {
    /*  ═══════════════════════════════════════════════════════════════════════════════════════════════════════ 
            1. CUSTOM ERRORS
        ═══════════════════════════════════════════════════════════════════════════════════════════════════════  */
     ...
     *  @param poolId The bytes32 pool Id
     *  @custom:event InitializeCygnusNebula Logs when an LP Token pair's price starts being tracked
     */
    event InitializeCygnusNebula(bool initialized, uint88 oracleId, address lpTokenPair, bytes32 poolId);
    ...
    /**
     *  @notice Public getter for an oracle
     */
     ...
     */
    function initializeNebula(address lpTokenPair, AggregatorV3Interface[] calldata _priceFeeds) external;
